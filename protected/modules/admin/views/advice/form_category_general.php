...
<div class="form">
    ...
    <div class="row buttons">
        ...
        <div class="right with-default-button">
            ...
            <a href="<?php echo $this->createUrl('advice/categoryDelete', array('id'=>$model->id)); ?>"
               onclick="return confirm('Вы действительно хотите удалить категорию?')" class="btn btn-danger">Удалить категорию</a>
            <? endif; ?>
            <? if(D::role('sadmin')): ?>
            <a href="<?php echo $this->createUrl('advice/categoryTotalDelete', array('id'=>$model->id, 'hash'=>md5($model->id))); ?>"
