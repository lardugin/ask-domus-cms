...
class ShopController extends AdminController
{
    ...
    public function actionCategory($id)
    {
	    ...
	    if(!$modeRelatedHidden) {
	        $c->mergeWith(Product::model()->getRelatedCriteria($categoryIDs), 'OR');
	    }
        $modelProduct=new Product;
        $c->mergeWith($modelProduct->orderById()->getDbCriteria());
        $modelProduct=new Product;
        $c->mergeWith($modelProduct->categoryOnTop($model->id)->getDbCriteria());
        $modelProduct=new Product;
        $c->mergeWith($modelProduct->scopeSort('shop_category', $model->id)->getDbCriteria());
