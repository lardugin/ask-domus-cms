						...
						<div class="project__right">
							<div class="project-foto">
								<ul id="project">
									...
									<li><a href="/images/project/luberci/1-1.jpg" class="fancybox" rel="progect-foto"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/1-1.jpg', 600, 420) ?>" alt="Люберцы1--"></a></li>
								...
								<div class="project-pager" id="bx-pager">
									<a data-slide-index="0" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/1.jpg', 92, 64) ?>" alt="Люберцы-2-0"></a>
									<a data-slide-index="1" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/2.jpg', 92, 64) ?>" alt="Люберцы-2-1"></a>
									<a data-slide-index="2" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/3.jpg', 92, 64) ?>" alt="Люберцы-2-2"></a>
									<a data-slide-index="3" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/4.jpg', 92, 64) ?>" alt="Люберцы-2-3"></a>
									<a data-slide-index="4" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/5.jpg', 92, 64) ?>" alt="Люберцы-2-4"></a>
									<a data-slide-index="5" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/6.jpg', 92, 64) ?>" alt="Люберцы-2-5"></a>
									<a data-slide-index="6" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/7.jpg', 92, 64) ?>" alt="Люберцы-2-6"></a>
									<a data-slide-index="7" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/8.jpg', 92, 64) ?>" alt="Люберцы-2-7"></a>
									<a data-slide-index="8" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/1-1.jpg', 92, 64) ?>" alt="Люберцы-2-8"></a>
									<a data-slide-index="9" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/2-1.jpg', 92, 64) ?>" alt="Люберцы-2-9"></a>
									<a data-slide-index="10" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/3-1.jpg', 92, 64) ?>" alt="Люберцы-2-10"></a>
									<a data-slide-index="11" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/4-1.jpg', 92, 64) ?>" alt="Люберцы-2-11"></a>
									<a data-slide-index="12" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/5-1.jpg', 92, 64) ?>" alt="Люберцы-2-12"></a>
									<a data-slide-index="13" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/6-1.jpg', 92, 64) ?>" alt="Люберцы-2-13"></a>
									<a data-slide-index="14" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/7-1.jpg', 92, 64) ?>" alt="Люберцы-2-14"></a>
									<a data-slide-index="15" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/8-1.jpg', 92, 64) ?>" alt="Люберцы-2-15"></a>
									<a data-slide-index="16" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/9-1.jpg', 92, 64) ?>" alt="Люберцы-2-16"></a>
									<a data-slide-index="17" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/10-1.jpg', 92, 64) ?>" alt="Люберцы-2-17"></a>
									<a data-slide-index="18" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/11-1.jpg', 92, 64) ?>" alt="Люберцы-2-18"></a>
									<a data-slide-index="19" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/12-1.jpg', 92, 64) ?>" alt="Люберцы-2-19"></a>
									<a data-slide-index="20" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/13-1.jpg', 92, 64) ?>" alt="Люберцы-2-20"></a>
									<a data-slide-index="21" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/14-1.jpg', 92, 64) ?>" alt="Люберцы-2-21"></a>
									<a data-slide-index="22" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/15-1.jpg', 92, 64) ?>" alt="Люберцы-2-22"></a>
									<a data-slide-index="23" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/16-1.jpg', 92, 64) ?>" alt="Люберцы-2-23"></a>
									<a data-slide-index="24" href="javascript:;"><img src="<?= ResizeHelper::resizeToCache('/images/project/luberci/17-1.jpg', 92, 64) ?>" alt="Люберцы-2-24"></a>
								</div>
							</div>
							<div class="center project-pdf">
								<a href="/doc/Lyubercy.pdf" target="_blank" class="button button_green button_arrow" onclick="yaCounter38644345.reachGoal('VIEW_PDF')">Скачать дизайн проект</a>
