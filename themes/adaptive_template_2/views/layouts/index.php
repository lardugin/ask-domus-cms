    ...
    <div class="index-text-box">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        <h2>ASK Domus – авторский дизайн интерьеров в Москве</h2>
                        <p>
                            Архитектурно-строительная компания ASK “Domus” – это студия дизайна и интерьера в Москве и области.
                            ...
                            Сотрудничество с ASK  “Domus” имеет ряд весомых преимуществ, которые оставляют позади наших конкурентов. Среди которых сроки, цена и качество выполняемых работ.
                        </p>
                        <h2>Заказать дизайн-проект интерьера</h2>
                        <p>
                            Компания ASK “Domus” предлагает авторский дизайн интерьера в Москве и области.
                            Кроме непосредственной работы с конечным клиентом, мы предлагаем выгодные условия сотрудничества с
                            дизайнерами и архитекторами для реализации уже готовых проектов и воплощения в жизнь мечты ваших клиентов.
                            Уточнить подробности и получить ответы на вопросы можно по телефону, указанному на сайте.
                        </p>
                        <p>
                            Более 11 успешных лет работы и тысячи довольных клиентов – это повод доверить нам работу над своим
                            помещением или участком, а мы всегда оправдываем оказанное доверие. АСК «Домус» - это ваш ориентир в мире дизайна и ремонта!
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="content">
                        ...
                        <p>
                            АСК «Домус» предлагает дизайн интерьера в Москве и области. Главные направления деятельности компании – это дизайн интерьеров,
                            ремонт квартир под ключ, архитектурное проектирование. У нас можно заказать дизайн-проект интерьера следующих объектов:
                        </p>
                        <ul>
                            <li>
